...
**Claim 4 is FALSIFIED; Claims 1, 2, 3, and 5 remain BLOCKED.** Exact source contracts now replace the rejected historical ontology. No source-only check is presented as scientific verification.
...
| 4 | [Claim 4](#/current-claim-4) | Yes | Counterexample inline | Yes | Analytic + implementation + independent Decimal | Clipped repair rejects counterexample | Exact named Algorithm 4/5 chain | FALSIFIED |
